        ...
        <nav className="glass flex items-center justify-between rounded-full px-4 py-2.5 md:px-6">
          <Link to="/" className="flex items-center gap-2.5">
            <div className="relative h-7 w-7">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-primary via-secondary to-accent opacity-90" />
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-full bg-gradient-to-r from-primary to-primary-glow px-4 py-1.5 text-[13px] font-semibold text-primary-foreground shadow-[0_0_20px_-4px_var(--color-primary)] transition hover:shadow-[0_0_28px_-2px_var(--color-primary)]">
              Sign in
            </button>
            <button
              onClick={() => setOpen((o) => !o)}
